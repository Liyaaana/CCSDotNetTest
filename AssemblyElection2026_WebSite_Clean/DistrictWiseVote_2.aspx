<%@ Page Language="C#" MasterPageFile="~/Election.Master" AutoEventWireup="true" CodeFile="DistrictWiseVote_2.aspx.cs" Inherits="DistrictWiseVote_2" %>
    ...
    <tr>
        ...
        <td>
            <asp:Label ID="Label4" runat="server" Font-Bold="True" ForeColor="#0033CC" 
                Text="Idukki" CssClass="style2"></asp:Label>
        </td>
        <td>
