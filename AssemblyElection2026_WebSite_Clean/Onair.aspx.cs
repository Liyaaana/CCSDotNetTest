...
using System.Data.SqlClient;
    ...
    public partial class Onair : System.Web.UI.Page
    {
    ...
    protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < dtq12.Rows.Count; j++)
            {
                ...
                if (dropdown == true)
                {
                    string update = "update CandidateDetailsN set Onair='" + 1 + "' where Id='" + key + "'";//lead
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            for (int j = 0; j < dtq12.Rows.Count; j++)
            {
                ...
                if (dropdown == true)
                {
                    string update = "update CandidateDetailsN set Onair='" + 0 + "' where Id='" + key + "'";//lead
                    SqlCommand cmd4 = new SqlCommand(update, con);
                    cmd4.ExecuteNonQuery();
                }
            }
