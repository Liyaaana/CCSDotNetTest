            ...
            &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;<asp:GridView ID="WbGridView" runat="server" AutoGenerateColumns="False" 
               ...
               ShowFooter="True" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <FooterTemplate>
                            <asp:Button ID="Button3" runat="server" onclick="WbBtn_Click" 
                                style="font-weight: 700" Text="UPDATE" />
                               <asp:Button ID="Button4" runat="server" OnClick="Button2_Click" 
                Text="Add New Party" style="font-weight: 700"/>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:TextBox ID="WbtxtBh1" runat="server" AutoComplete="Off" Max="60"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" 
                                ControlToValidate="WbtxtBh1" ErrorMessage="Only Numbers allowed" 
                                ValidationExpression="\d+$"></asp:RegularExpressionValidator>
                           <%-- <asp:RangeValidator runat="server" ID="range1" MinimumValue="0" MaximumValue="60" ControlToValidate="TextBox1"  ErrorMessage="Max Value is 60"></asp:RangeValidator>--%>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <asp:GridView ID="AsGridView" runat="server" AutoGenerateColumns="False" 
               ...
               ShowFooter="True" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <FooterTemplate>
                            <asp:Button ID="Button5" runat="server" onclick="AsBtn_Click" 
                                style="font-weight: 700" Text="UPDATE" />
                               <asp:Button ID="Button6" runat="server" OnClick="Button2_Click" 
                Text="Add New Party" style="font-weight: 700"/>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:TextBox ID="AstxtBh1" runat="server" AutoComplete="Off" Max="60"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" 
                                ControlToValidate="AstxtBh1" ErrorMessage="Only Numbers allowed" 
                                ValidationExpression="\d+$"></asp:RegularExpressionValidator>
                           <%-- <asp:RangeValidator runat="server" ID="range1" MinimumValue="0" MaximumValue="60" ControlToValidate="TextBox1"  ErrorMessage="Max Value is 60"></asp:RangeValidator>--%>
                        </ItemTemplate>
                    </asp:TemplateField>
            ...
            <asp:GridView ID="TnGridView" runat="server" AutoGenerateColumns="False" 
               ...
               ShowFooter="True" 
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <FooterTemplate>
                            <asp:Button ID="Button7" runat="server" onclick="TnBtn_Click" 
                                style="font-weight: 700" Text="UPDATE" />
                               <asp:Button ID="Button8" runat="server" OnClick="Button2_Click" 
                Text="Add New Party" style="font-weight: 700"/>
                        </FooterTemplate>
                        <ItemTemplate>
                            <asp:TextBox ID="TntxtBh1" runat="server" AutoComplete="Off" Max="60"></asp:TextBox>
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator6" runat="server" 
                                ControlToValidate="TntxtBh1" ErrorMessage="Only Numbers allowed" 
                                ValidationExpression="\d+$"></asp:RegularExpressionValidator>
                           <%-- <asp:RangeValidator runat="server" ID="range1" MinimumValue="0" MaximumValue="60" ControlToValidate="TextBox1"  ErrorMessage="Max Value is 60"></asp:RangeValidator>--%>
                        </ItemTemplate>
                    </asp:TemplateField>
