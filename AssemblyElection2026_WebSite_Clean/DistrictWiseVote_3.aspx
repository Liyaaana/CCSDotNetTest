<%@ Page Language="C#" MasterPageFile="~/Election.Master" AutoEventWireup="true" CodeFile="DistrictWiseVote_3.aspx.cs" Inherits="DistrictWiseVote_3" %>
    ...
    <tr>
        ...
        <td class="style3">
            <asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="#0033CC" 
                Text="Patanamthitta" CssClass="style2"></asp:Label>
        </td>
        <td class="style3">
