<%@ Page Language="C#" MasterPageFile="~/Election.Master" AutoEventWireup="true" CodeFile="Onair.aspx.cs" Inherits="Onair" %>
    ...
    <tr>
        ...
        <td class="style40">
            <asp:Label ID="Label4" runat="server" style=" font-size: large;"  
                Text="District" Font-Size="Medium" font-Weight="Bold" 
