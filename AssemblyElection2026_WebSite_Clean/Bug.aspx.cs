...
using System.Data;
    ...
    public partial class Bug : System.Web.UI.Page
    {
        ...
        public void Bihar()
        {
            string sqldata = "select *from StateSeat where PartyId=4";
    ...
    protected void BhBtn_Click(object sender, EventArgs e)
        {
            ...
            if (totalseats <= seatotal)
            {
                ...
                string barheight = "select top 1 New_seat from dbo.StateSeat where PartyId=4 order by New_seat desc";
    ...
    public void LDF()
    {
        string sqldata = "select *from StateSeat where PartyId=1";
        SqlCommand cmde = new SqlCommand(sqldata, con);
        SqlDataAdapter data = new SqlDataAdapter(cmde);
        DataTable dttt = new DataTable();
        data.Fill(dttt);
        LDFGridView.DataSource = dttt;
        LDFGridView.DataBind();
        Session["LDFDATA"] = dttt;
    }

    


    protected void LDFBtn_Click(object sender, EventArgs e)
    {
        get();
        DataTable dttt = (DataTable)Session["LDFDATA"];
        Session["LDFDATA"] = dttt;
        int totalseats = 0;
        ...
        {
            string textbox = "";
            string t1 = ((TextBox)LDFGridView.Rows[i].Cells[0].FindControl("LDFtxtBh1")).Text;
            if (string.IsNullOrEmpty(t1))
            {
                textbox = LDFGridView.Rows[i].Cells[2].Text;
            }
            else
            {
                textbox = t1;
        ...
        if (totalseats <= seatotal)
        {
            for (int i = 0; i < dttt.Rows.Count; i++)
            {
                string key = LDFGridView.DataKeys[i].Value.ToString();
                string textbox = ((TextBox)LDFGridView.Rows[i].Cells[0].FindControl("LDFtxtBh1")).Text;
                //***********
                //string textbox1 = ((TextBox)jkGridView.Rows[i].Cells[1].FindControl("txtJK2")).Text;
            ...
            string barheight = "select top 1 New_seat from dbo.StateSeat where PartyId=1 order by New_seat desc";
            SqlCommand bar = new SqlCommand(barheight, con);
            int barvalue = SafeToInt(bar.ExecuteScalar());
            int sum1 = 0;
            for (int i = 0; i < dttt.Rows.Count; i++)
    ...
    protected void LDFGridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        get();
        string key = LDFGridView.DataKeys[e.RowIndex].Values[0].ToString();
        string update = "delete from StateSeat where Id='" + key + "'";
        SqlCommand updatee = new SqlCommand(update, con);
        updatee.ExecuteNonQuery();
        con.Close();
        LDFGridView.EditIndex = -1;
        LDF();
    }

    protected void LDFGridView_RowEditing(object sender, GridViewEditEventArgs e)
    {
        get();
        LDFGridView.EditIndex = e.NewEditIndex;
        LDF();
        con.Close();
    }
    protected void LDFGridView_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        get();
        string key = LDFGridView.DataKeys[e.RowIndex].Values[0].ToString();
        string p_name = ((TextBox)LDFGridView.Rows[e.RowIndex].Cells[0].Controls[0]).Text;
    ...
    protected void LDFGridView_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
    {
        get();
        LDFGridView.EditIndex = -1;
        LDF();
    ...
    public void UDF()
    {
        string sqldata = "select *from StateSeat where PartyId=2";
        SqlCommand cmde = new SqlCommand(sqldata, con);
        SqlDataAdapter data = new SqlDataAdapter(cmde);
        DataTable dttt = new DataTable();
        data.Fill(dttt);
        UDFGridView.DataSource = dttt;
        UDFGridView.DataBind();
        Session["UDFDATA"] = dttt;
    }




    protected void UDFBtn_Click(object sender, EventArgs e)
    {
        get();
        DataTable dttt = (DataTable)Session["UDFDATA"];
        Session["UDFDATA"] = dttt;
        int totalseats = 0;
        ...
        {
            string textbox = "";
            string t1 = ((TextBox)UDFGridView.Rows[i].Cells[0].FindControl("UDFtxtBh1")).Text;
            if (string.IsNullOrEmpty(t1))
            {
                textbox = UDFGridView.Rows[i].Cells[2].Text;
            }
            else
            {
                textbox = t1;
        ...
        if (totalseats <= seatotal)
        {
            for (int i = 0; i < dttt.Rows.Count; i++)
            {
                string key = UDFGridView.DataKeys[i].Value.ToString();
                string textbox = ((TextBox)UDFGridView.Rows[i].Cells[0].FindControl("UDFtxtBh1")).Text;
                //***********
                //string textbox1 = ((TextBox)jkGridView.Rows[i].Cells[1].FindControl("txtJK2")).Text;
            ...
            string barheight = "select top 1 New_seat from dbo.StateSeat where PartyId=2 order by New_seat desc";
            SqlCommand bar = new SqlCommand(barheight, con);
            int barvalue = SafeToInt(bar.ExecuteScalar());
            int sum1 = 0;
            for (int i = 0; i < dttt.Rows.Count; i++)
    ...
    protected void UDFGridView_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        get();
        string key = UDFGridView.DataKeys[e.RowIndex].Values[0].ToString();
        string update = "delete from StateSeat where Id='" + key + "'";
        SqlCommand updatee = new SqlCommand(update, con);
        updatee.ExecuteNonQuery();
        con.Close();
        UDFGridView.EditIndex = -1;
        UDF();
    }

    protected void UDFGridView_RowEditing(object sender, GridViewEditEventArgs e)
    {
        get();
        UDFGridView.EditIndex = e.NewEditIndex;
        UDF();
        con.Close();
    }
    protected void UDFGridView_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        get();
        string key = UDFGridView.DataKeys[e.RowIndex].Values[0].ToString();
        string p_name = ((TextBox)UDFGridView.Rows[e.RowIndex].Cells[0].Controls[0]).Text;
    ...
    protected void UDFGridView_RowCancelingEdit(object sender, GridViewCancelEditEventArgs e)
    {
        get();
        UDFGridView.EditIndex = -1;
        UDF();
    ...
    public void NDA()
    {
        string sqldata = "select *from StateSeat where PartyId=3";
        SqlCommand cmde = new SqlCommand(sqldata, con);
        SqlDataAdapter data = new SqlDataAdapter(cmde);
        DataTable dttt = new DataTable();
        data.Fill(dttt);
    ...
    protected void NDABtn_Click(object sender, EventArgs e)
    {
        ...
        {
            string textbox = "";
            string t1 = ((TextBox)NDAGridView.Rows[i].Cells[0].FindControl("NDAtxtBh1")).Text;
            if (string.IsNullOrEmpty(t1))
            {
        ...
        if (totalseats <= seatotal)
        {
            for (int i = 0; i < dttt.Rows.Count; i++)
            {
                ...
                string textbox = ((TextBox)NDAGridView.Rows[i].Cells[0].FindControl("NDAtxtBh1")).Text;
                //***********
                //string textbox1 = ((TextBox)jkGridView.Rows[i].Cells[1].FindControl("txtJK2")).Text;
            ...
            string barheight = "select top 1 New_seat from dbo.StateSeat where PartyId=3 order by New_seat desc";
            SqlCommand bar = new SqlCommand(barheight, con);
            int barvalue = SafeToInt(bar.ExecuteScalar());
            int sum1 = 0;
            for (int i = 0; i < dttt.Rows.Count; i++)
