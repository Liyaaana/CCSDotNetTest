    ...
    <tr>
        ...
        <td class="style29">
            ...
            <asp:Button ID="Button1" runat="server" Font-Bold="True" Font-Size="Medium" 
                Height="45px" onclick="Button1_Click" Text="Save" Width="84px" 
                style="background-color: #C0C0C0" />
            
            
            <asp:Button ID="Button2" runat="server" Font-Bold="True" Font-Size="Medium" PostBackUrl="~/Bug.aspx" 
                Height="45px" onclick="Button1_Click" Text="Back" Width="112px" 
                style="background-color: #C0C0C0" />
    ...
    <tr>
        <td class="style6">
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                style="background-color: #CCCCCC" Width="547px">
                <Columns>
